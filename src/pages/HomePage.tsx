...
export function HomePage() {
  ...
  return (
    <div>
      {/* Hero */}
      <section className="relative h-[70vh] min-h-[500px] w-full overflow-hidden bg-ink-900">
        ...
        <div className="relative mx-auto flex h-full max-w-7xl flex-col justify-center px-4">
          <div className="max-w-xl animate-fade-in-up">
            <p className="mb-3 text-sm font-medium uppercase tracking-[0.3em] text-accent-400">New Season</p>
            <h1 className="font-display text-4xl font-bold leading-tight text-white sm:text-5xl lg:text-6xl">
              {heroBanner.title}
            </h1>
            <p className="mt-4 max-w-md text-base text-ink-200 sm:text-lg">{heroBanner.subtitle}</p>
      ...
      <section className="border-b border-ink-100 bg-ink-50">
        ...
        { icon: ShieldCheck, title: 'Secure Payment', desc: '100% protected checkout' },
          ...
          <div key={item.title} className="flex items-center gap-3">
            <item.icon size={24} className="shrink-0 text-ink-700" />
            <div>
